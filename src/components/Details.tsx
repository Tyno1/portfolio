  ...
  return (
    <div className="relative min-h-screen bg-[#0f0f0f]">
      ...
      <div className="px-6 md:px-10 lg:px-20 xl:px-40 py-10 flex flex-col gap-10 relative z-10">
        ...
        <div className="top-section flex flex-col lg:flex-col gap-10 items-start animate-fade-in-up">
          <div className="image-container w-full sm:w-[70vw] md:w-[50vw] lg:w-[50vw] h-[40vh] bg-white hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-2xl rounded-lg overflow-hidden">
            <img
